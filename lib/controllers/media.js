...
MediaController.prototype.sessionRequest = function(data, callback) {
  ...
  if (this.currentSession == null) {
   return callback(new Error('No current session'));
  }
...
MediaController.prototype.subtitlesOff = function(callback) { // eigen uitvinding
  this.sessionRequest({ type: 'EDIT_TRACKS_INFO',  activeTrackIds: [] }, callback);
};
